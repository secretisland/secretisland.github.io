...
async function getMts() {
    ...
    if (Nfts == undefined) {
        ...
        stakedNFT = await purrContract.methods.stakedNFTSByUser(account).call();
        PURRbalance = await purrContract.methods.balanceOf(account).call();
